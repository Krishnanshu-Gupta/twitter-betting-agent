...
var _dec, _class, _dec2, _class2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class3, _class4;
let Outcome = /*#__PURE__*/function (Outcome) {
  Outcome[Outcome["Yes"] = 0] = "Yes";
  Outcome[Outcome["No"] = 1] = "No";
  Outcome[Outcome["Undecided"] = 2] = "Undecided";
  return Outcome;
}({});
let Bet = (_dec = NearBindgen({}), _dec(_class = class Bet {
  // Using bigint for proper balance handling

  constructor(user, amount, outcome) {
    this.user = user;
    this.amount = amount;
    this.outcome = outcome;
  }
}) || _class);
let Market = (_dec2 = NearBindgen({}), _dec2(_class2 = class Market {
  // Using bigint for arithmetic operations

  // Market expiration time

  constructor(id, description, endTime) {
    this.id = id;
...
let PredictionMarket = (_dec3 = NearBindgen({}), _dec4 = view(), _dec5 = call({}), _dec6 = call({
  payableFunction: true
}), _dec7 = call({}), _dec8 = view(), _dec9 = view(), _dec3(_class3 = (_class4 = class PredictionMarket {
  // Persistent state.
  markets = new UnorderedMap("m");
  marketCounter = 0;
   ...
   */
  ensureState() {
    if (!this.markets || this.markets._prefix === undefined) {
      this.markets = new UnorderedMap("m");
    }
  ...
  createMarket({
    ...
    const currentTime = BigInt(blockTimestamp());
    ...
    log(`Market ${this.marketCounter} created: ${description}`);
    return this.marketCounter;
  }
  placeBet({
    marketId,
    ...
    const bet = new Bet(predecessorAccountId(), deposit, outcome);
    ...
    log(`Bet placed: ${deposit.toString()} on ${outcomeStr}`);
  }
  ...
  distributePayouts(market, outcome) {
    ...
    for (const bet of market.bets) {
      if (bet.outcome === outcome) {
        ...
        const promise = promiseBatchCreate(bet.user);
        promiseBatchActionTransfer(promise, payout);
      }
    }
  }
  refundAll(market) {
    for (const bet of market.bets) {
      const promise = promiseBatchCreate(bet.user);
      promiseBatchActionTransfer(promise, bet.amount);
    }
  }
  parseOutcome(outcomeStr) {
...
}, _applyDecoratedDescriptor(_class4.prototype, "getMarketCounter", [_dec4], Object.getOwnPropertyDescriptor(_class4.prototype, "getMarketCounter"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "createMarket", [_dec5], Object.getOwnPropertyDescriptor(_class4.prototype, "createMarket"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "placeBet", [_dec6], Object.getOwnPropertyDescriptor(_class4.prototype, "placeBet"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "resolveMarketWithOutcome", [_dec7], Object.getOwnPropertyDescriptor(_class4.prototype, "resolveMarketWithOutcome"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "getMarket", [_dec8], Object.getOwnPropertyDescriptor(_class4.prototype, "getMarket"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "getAllMarkets", [_dec9], Object.getOwnPropertyDescriptor(_class4.prototype, "getAllMarkets"), _class4.prototype), _class4)) || _class3);
function getAllMarkets() {
  const _state = PredictionMarket._getState();
  if (!_state && PredictionMarket._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = PredictionMarket._create();
  if (_state) {
    PredictionMarket._reconstruct(_contract, _state);
  }
  const _args = PredictionMarket._getArgs();
  const _result = _contract.getAllMarkets(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(PredictionMarket._serialize(_result, true));
}
function getMarket() {
  const _state = PredictionMarket._getState();
  if (!_state && PredictionMarket._requireInit()) {
  ...
  const _args = PredictionMarket._getArgs();
  const _result = _contract.getMarket(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(PredictionMarket._serialize(_result, true));
}
function resolveMarketWithOutcome() {
  const _state = PredictionMarket._getState();
  if (!_state && PredictionMarket._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = PredictionMarket._getArgs();
  const _result = _contract.resolveMarketWithOutcome(_args);
...
function placeBet() {
  ...
  const _args = PredictionMarket._getArgs();
  const _result = _contract.placeBet(_args);
  PredictionMarket._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(PredictionMarket._serialize(_result, true));
}
function createMarket() {
  ...
  const _args = PredictionMarket._getArgs();
  const _result = _contract.createMarket(_args);
  PredictionMarket._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(PredictionMarket._serialize(_result, true));
}
function getMarketCounter() {
  const _state = PredictionMarket._getState();
  if (!_state && PredictionMarket._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = PredictionMarket._getArgs();
  const _result = _contract.getMarketCounter(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(PredictionMarket._serialize(_result, true));
}

export { Bet, Market, Outcome, PredictionMarket, createMarket, getAllMarkets, getMarket, getMarketCounter, placeBet, resolveMarketWithOutcome };
